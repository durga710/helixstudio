...
export const ARCHETYPES: Archetype[] = [
  ...
  { id: "game3d", label: "Browser game (3D)", keywords: ["3d game", "3d", "three.js", "threejs", "babylon", "maze", "first person", "fps", "voxel", "3d world"], stack: "Static site (Babylon.js)", features: ["3d scene", "camera controls", "game loop", "responsive controls"] },
