...
export const ARCHETYPES: Archetype[] = [
  ...
  { id: "game", label: "Browser game (2D)", keywords: ["game", "puzzle", "arcade", "platformer", "flappy", "mario", "runner", "snake", "pong", "shooter", "2d game"], stack: "Static site (Phaser)", features: ["game loop", "responsive controls", "animation", "score & restart"], question: { key: "genre", text: "What kind of game — action, puzzle, or endless runner?", options: ["Action / arcade", "Puzzle", "Endless runner"] } },
  { id: "game3d", label: "Browser game (3D)", keywords: ["3d game", "3d", "three.js", "threejs", "playcanvas", "babylon", "maze", "first person", "fps", "voxel", "3d world"], stack: "Static site (PlayCanvas)", features: ["3d scene", "camera controls", "game loop", "responsive controls"] },
